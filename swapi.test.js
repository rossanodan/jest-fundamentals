...
describe("Star Wars Search", () => {
  // First way - with done()
  it("calls Star Wars APIs to get people", (done) => {
    expect.assertions(1);
  ...
  // Second way - returning the promise
  it("calls Star Wars APIs to get people", () => {
    expect.assertions(1);
  ...
  it("calls Star Wars APIs to get people with a promise", () => {
    expect.assertions(2);
